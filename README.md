...
-   [o] User can press a button to start and stop the display
-   [o] User can change the interval of time controlling the change in intensity
...
-   [o] User can specify the number of rows to be included in the display. From
